                ...
                <div class="panel-body">      
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            ])->textInput()->input('email', ['placeholder' => Yii::t('user', "Email")])->label(false);
                            ?>                        
                        </div>  
                        ...
                        <div class="col-sm-12">
                            ...
                            ])->passwordInput()->input('password', ['placeholder' => Yii::t('user', "Password")])->label(false);
                            ?>
                        </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            ])->dropDownList($model->timezoneslist)->label(Yii::t('user', 'Time Zone')); //->input('email', ['placeholder' => Yii::t('user', "Enter Timezone")])->label(false);
                            ?>                        
                        </div>  
                        ...
                        <div class="col-sm-12">
                            ...
                            $form->field($model, 'terms', ['template' => "{input}"])->checkbox([
                                //'class' => 'icheck',
                                'label' => Yii::t('user', 'I Agree with the {terms}', ['terms' => Html::a(Yii::t('user', 'Terms'), ['/site/terms'])])
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 controls">
                                <?= Html::submitButton('<i class="fa fa-pencil-square-o"></i> ' . Yii::t('user', 'Sign Up'), ['class' => 'btn btn-success btn-block', 'name' => 'login-button']) ?>
                            </div>
                        </div>
                        <?php ActiveForm::end() ?>
                    </div>
